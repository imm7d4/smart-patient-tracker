    ...
    <Dialog open={open} disableEscapeKeyDown>
      ...
      <DialogContent>
        <DialogContentText paragraph>
          To participate in this Smart Treatment Plan, we require your
          explicit consent for the following:
        </DialogContentText>
        ...
        <FormControlLabel
          ...
          label={
            <Typography variant="body2">
              <b>Monitoring Consent:</b> I agree to share my daily health
              check-in data (pain levels, symptoms, medication adherence)
              with my assigned doctor for the purpose of medical monitoring.
            </Typography>
          }
          sx={{mb: 2}}
        />
        ...
        <FormControlLabel
          ...
          label={
            <Typography variant="body2">
              <b>Messaging Consent:</b> I agree to receive secure messages
              and automated alerts from my doctor and the system regarding
